...
router
  ...
  .put(validate(deviceValidation.updateDevice), deviceController.updateDevice);
 ...
 *         schema:
 *           type: string
 *         description: sort by query in the device of field:desc/asc (ex. name:asc)
 *       - in: query
 *         name: limit
 *         schema:
 *           type: integer
 ...
 *     description: Logged in devices can fetch only their own device indeviceation. Only admins can fetch other devices.
 *     tags: [Devices]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in devices can only update their own indeviceation. Only admins can update other devices.
 *     tags: [Devices]
 *     security:
 *       - bearerAuth: []
 *     parameters:
